...
As a running example, we will consider permutation tests for a simplified verison of [gene set enrichment analysis](http://www.pnas.org/content/102/43/15545.full).
...
<a href='https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE46581'>here</a> and is named [YaleTNBC.RData](./YaleTNBC.RData).

The gene sets in [c6.unsigned.RData](./c6.unsigned.RData) come from <a href='http://software.broadinstitute.org/gsea/msigdb/collections.jsp'>MSigDB</a>.
...
## Practice Exercises
 ...
 [Exercises_R_parallel.R](./Exercises_R_Parallel.R)
