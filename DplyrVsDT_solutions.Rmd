...
_ This code finds all destination cities for which more than 75% of
...
```
 ...
 a. Provide a one-sentence summary of what is being computed.
 _ For each carrier and origin airport, this code counts the number of destination
...
```
  ...
  _ This code computes the number of flights from NYC to HOU each month
  by carrier. _
